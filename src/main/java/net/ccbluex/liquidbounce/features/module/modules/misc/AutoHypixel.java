...
public class AutoHypixel extends Module {
    ...
    private final ListValue megaValue = new ListValue("Mega-Mode", new String[]{"Normal", "Doubles"}, "Normal", () -> { return modeValue.get().equalsIgnoreCase("mega"); });
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        Stencil.erase(true);
        RenderUtils.drawRect(middleX - 5F - middleWidth, posY, middleX - 5F - middleWidth + wid, posY + 15F, new Color(0.9F, 0.12F, 0.12F, 0.35F).getRGB());
        Stencil.dispose();
