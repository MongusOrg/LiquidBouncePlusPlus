...
public final class IconUtils {
    ...
    public static ByteBuffer[] getFavicon() {
        try {
            return new ByteBuffer[] {readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/liquidbounce+/logo_16x16.png")), readImageToBuffer(IconUtils.class.getResourceAsStream("/assets/minecraft/liquidbounce+/logo_32x32.png"))};
        }catch(IOException e) {
            e.printStackTrace();
        }
        return null;
