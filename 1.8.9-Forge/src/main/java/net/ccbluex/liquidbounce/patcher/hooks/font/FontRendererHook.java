...
import net.ccbluex.liquidbounce.injection.forge.mixins.accessors.GlStateManagerAccessor;
...
import net.ccbluex.liquidbounce.patcher.util.enhancement.text.CachedString;
...
public final class FontRendererHook {
    ...
    private void establishSize() {
        ...
        try (final InputStream stream = mc.getResourceManager().getResource(fontRendererAccessor.getLocationFontTexture()).getInputStream()) {
            ...
            ClientUtils.getLogger().error("Failed to read font texture while establishing size.", e);
        }
    ...
    public void create() {
        ...
        try (final InputStream stream = mc.getResourceManager().getResource(fontRendererAccessor.getLocationFontTexture()).getInputStream()) {
            ...
            ClientUtils.getLogger().error("Failed to draw texture sheet.", e);
        }
