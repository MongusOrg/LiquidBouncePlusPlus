...
public class Scaffold extends Module {
    ...
    public void onRender2D(final Render2DEvent event) {
        ...
        if (counterMode.equalsIgnoreCase("sigma")) {
            ...
            //GL11.glPopMatrix();
            RenderUtils.drawRoundedRect(scaledResolution.getScaledWidth() / 2 - (infoWidth / 2) - 4, scaledResolution.getScaledHeight() - 60, scaledResolution.getScaledWidth() / 2 + (infoWidth / 2) + 4, scaledResolution.getScaledHeight() - 74, 4F, new Color(0.25F, 0.25F, 0.25F, progress).getRGB());
            GlStateManager.resetColor();
