...
class FastUse : Module() {
    ...
    private val customSpeedValue = IntegerValue("CustomSpeed", 2, 0, 35, { modeValue.get().equals("customdelay", true) })
    private val customTimer = FloatValue("CustomTimer", 1.1f, 0.5f, 2f, { modeValue.get().equals("customdelay", true) })
