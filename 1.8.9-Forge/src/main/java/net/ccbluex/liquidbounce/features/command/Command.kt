...
abstract class Command(val command: String, val alias: Array<String>) : MinecraftInstance() {
    ...
    protected fun chatSyntax(syntaxes: Array<String>) {
        ClientUtils.displayChatMessage("§8[§0§l${LiquidBounce.CLIENT_NAME}§8] §3Syntax:")
     ...
     */
    protected fun chatSyntaxError() = ClientUtils.displayChatMessage("§8[§0§l${LiquidBounce.CLIENT_NAME}§8] §3Syntax error")
