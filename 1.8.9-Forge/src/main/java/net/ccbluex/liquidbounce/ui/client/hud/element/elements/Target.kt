        ...
        if (target is EntityPlayer) {
            when (styleValue.get()) {
                ...
                "AstolfoOld" -> {
                    ...
                    font.drawString("${decimalFormat3.format(target.health)} ❤", 19F, 9F, color.rgb, true)
                    GL11.glPopMatrix()
                }
                ...
                "AstolfoNew" -> {
                    ...
                    Fonts.minecraftFont.drawString("${decimalFormat3.format(target.health)} ❤", 0F, 0F, barColor.rgb, true)
                    GL11.glPopMatrix()
