...
class GuiUpdate : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        drawCenteredString(Fonts.font35, "EvoBounce b${LiquidBounce.latestVersion} got released!", width / 2, height / 8 + 80, 0xffffff)
        drawCenteredString(Fonts.font35, "Please recheck EvoLife's discord to get new version or dismiss this message by pressing \"OK\".", width / 2, height / 8 + 80 + Fonts.font35.FONT_HEIGHT, 0xffffff)
