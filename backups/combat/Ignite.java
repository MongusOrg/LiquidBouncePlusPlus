...
public class Ignite extends Module {
   ...
   public void onUpdate(final UpdateEvent event) {
      ...
      final int lighterInHotbar =
         lighterValue.get() ? InventoryUtils.INSTANCE.findItem(36, 45, Items.flint_and_steel) : -1;
      final int lavaInHotbar =
         lavaBucketValue.get() ? InventoryUtils.INSTANCE.findItem(26, 45, Items.lava_bucket) : -1;
