...
class GuiWelcome : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        font.drawCenteredString("Here is some information you might find useful if you are using EvoBounce for the first time.", width / 2F, height / 8F + 70 + font.FONT_HEIGHT, 0xffffff, true)
        ...
        font.drawCenteredString("Forum: https://forums.ccbluex.net/", width / 2F, height / 8F + 80 + font.FONT_HEIGHT * 15, 0xffffff, true)
